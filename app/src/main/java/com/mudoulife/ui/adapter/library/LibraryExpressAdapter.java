 ...
 * project : MuDouLife
 */
public class LibraryExpressAdapter extends LibraryBaseAdapter<LibraryBaseData> {
    private static final String STRING_PRICE = "0.5元/张/层";
    public LibraryExpressAdapter(List<LibraryBaseData> data, Context context) {
        super(data, context);
    }

    @Override
    protected void bindView(ViewHolder viewHolder,LibraryBaseData data) {
        initExpressView(viewHolder, data);
    }
