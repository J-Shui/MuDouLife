 ...
 * project : MuDouLife
 */
public class LibraryCarryAdapter extends LibraryBaseAdapter<LibraryBaseData> {
    private static final String STRING_PRICE = "0.5元/张/层";
    public LibraryCarryAdapter(List<LibraryBaseData> data, Context context) {
        super(data, context);
    }

    @Override
    protected void bindView(ViewHolder viewHolder,LibraryBaseData data) {
        initCarrayView(viewHolder, data);
    }
